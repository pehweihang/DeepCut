...
class GNNpool(nn.Module):
    def __init__(self, input_dim, conv_hidden, num_layers, v2, mlp_hidden, num_clusters, device):
        """
        ...
        # GNN conv
        self.convs = pyg_nn.GAT(input_dim, conv_hidden, num_layers, v2=v2, act="relu")
        # MLP
